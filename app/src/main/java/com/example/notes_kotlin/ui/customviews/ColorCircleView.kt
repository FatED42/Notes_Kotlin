package com.example.notes_kotlin.ui.customviews
...
import com.example.notes_kotlin.extensions.dip
...
class ColorCircleView @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) : View(context, attrs, defStyleAttr) {
    ...
    @Dimension(unit = Dimension.PX) var strokeWidth: Float = dip(defStrokeWidthDp)
        set(value) {
            field = value
